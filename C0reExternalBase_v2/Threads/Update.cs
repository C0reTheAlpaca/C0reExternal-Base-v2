        ...
        public static void Read()
        {
            while (true)
            {
                ...
                for (var i = 0; i < 64; i++)
                {
                    ...
                    if (Entity.m_iBase > 0)
                    {
                        Entity.m_Origin = ManageMemory.ReadMemory<Vector3D>(Entity.m_iBase + Offsets.m_vecOrigin);
                        ...
                        Entity.m_iTeam = ManageMemory.ReadMemory<int>(Entity.m_iBase + Offsets.m_lifeState);
